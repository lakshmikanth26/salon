...

{
...

    {
        ...
        $this->auth_model->trigger_events('user_logout');



    

        $identity = $this->config->item('user_identity', 'ion_auth');

        $this->session->unset_userdata(array($identity => '', 'id' => '', 'user' => ''));
...

    {
        ...
        $this->auth_model->trigger_events('user_logged_in');
