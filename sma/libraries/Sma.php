...

{
    ...
    public function send_sms($to, $message)
    {
        ...
        if($to){
            $url = 'http://trans.indocweb.com/api/sendmsg.php?' . http_build_query([
            'user' => 'infinitysalon',
            'pass' => 'Infinity@123',
            'sender' => 'INFNTY',
            'phone' => $to,
    ...
    public function deduct_award_points($total, $customer, $user, $scope = NULL)

    {
        if ($this->Settings->each_spent) {
            ...
            $total_points = $company->award_points - $total;
