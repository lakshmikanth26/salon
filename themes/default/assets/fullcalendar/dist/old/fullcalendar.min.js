! function(t, e) {
    ...
    return function(n) {
        ...
        l.isPrimaryMouseButton = function(t) {
            ...
            var n;
            return o(t) ? v.duration(t * e) : (n = t.asMonths(), 1 <= Math.abs(n) && g(n) ? v.duration({
                months: n * e
            }) : v.duration({
                days: t.asDays() * e
            }))
        ...
        }, l.hasOwnProp = h, l.applyAll = function(t, e, n) {
        ...
        function r(t, e) {
            return b(m(o(e).fakeFormatString, t).join(""))
        }
        ...
        function o(t) {
            return g[t] || (g[t] = {
                fakeFormatString: function t(e) {
                    var n, i, r = [];
                    for (n = 0; n < e.length; n++) "string" == typeof(i = e[n]) ? r.push("[" + i + "]") : i.token ? i.token in h ? r.push(d + "[" + i.token + "]") : r.push(i.token) : i.maybe && r.push(c + t(i.maybe) + c);
                    return r.join(u)
                }(e = s(t)),
        ...
        function m(t, e) {
            ...
            for (n = 0; n < o.length; n++)(i = o[n]).charAt(0) === d ? r.push(h[i.substring(1)](e)) : r.push(i);
            return r
        }
            ...
            H = function() {
                ...
                return t.prototype.constructed = function() {}, t.prototype.getView = function() {
                    ...
                    i.addClass("fc"), i.on("click.fc", "a[data-goto]", function(t) {
                        ...
                        var e = new(I.getThemeSystemClass(t.themeSystem || t.theme))(o.optionsManager),
                            n = e.getClass("widget");
                        ...
                        o.businessHourGenerator = new E.default(t.businessHours, o), o.view && o.view.set("businessHourGenerator", o.businessHourGenerator)
                    }, function() {
        ...
        var p = n(0),
            ...
            i = function() {
                ...
                return t.prototype.opt = function(t) {
                    ...
                    return i = this.buildValidRange(), i = this.trimHiddenDays(i), n && (t = this.msToUtcMoment(i.constrainDate(t), c)), r = this.buildCurrentRangeInfo(t, e), o = /^(year|month|week|day)$/.test(r.unit), s = this.buildRenderRange(this.trimHiddenDays(r.unzonedRange), r.unit, o), a = (s = this.trimHiddenDays(s)).clone(), this.opt("showNonCurrentDates") || (a = a.intersect(r.unzonedRange)), u = p.duration(this.opt("minTime")), d = p.duration(this.opt("maxTime")), (a = (a = this.adjustActiveRange(a, u, d)).intersect(i)) && (t = this.msToUtcMoment(a.constrainDate(t), c)), l = r.unzonedRange.intersectsWith(i), {
                        validUnzonedRange: i,
                    ...
                    function r() {
                        a = t.clone().startOf(d), l = a.clone().add(n), u = new h.default(a, l)
                    }
                    var o, s, a, l, u, d = this.opt("dateAlignment");
                    return d || ((o = this.opt("dateIncrement")) ? (s = p.duration(o), d = s < n ? c.computeDurationGreatestUnit(s, o) : i) : d = i), n.as("days") <= 1 && this._view.isHiddenDay(a) && (a = this._view.skipHiddenDays(a, e)).startOf("day"), r(), this.trimHiddenDays(u) || (t = this._view.skipHiddenDays(t, e), r()), u
        ...
        var i = n(2),
            ...
            l = function(e) {
                ...
                return i.__extends(t, e), t.prototype.end = function() {
                    ...
                    var r, i, o, s, a, l, u, d = this,
                        c = this.component,
                        p = this.view,
                        h = (i = e, (u = v.dataAttrPrefix) && (u += "-"), (o = i.data(u + "event") || null) && (null == (s = (o = "object" == typeof o ? f.extend({}, o) : {}).start) && (s = o.time), a = o.duration, l = o.stick, delete o.start, delete o.time, delete o.duration, delete o.stick), null == s && (s = i.data(u + "start")), null == s && (s = i.data(u + "time")), null == a && (a = i.data(u + "duration")), null == l && (l = i.data(u + "stick")), {
                            eventProps: o,
                    ...
                    (this.dragListener = new m.default(c, {
                        ...
                        hitOver: function(t) {
                            ...
                            i ? (r = d.computeExternalDrop(i, h)) ? (e = new b.default(r.buildInstances()), n = h.eventProps ? c.isEventInstanceGroupAllowed(e) : c.isExternalInstanceGroupAllowed(e)) : n = !1 : n = !1, n || (r = null, y.disableCursor()), r && c.renderDrag(c.eventRangesToEventFootprints(e.sliceRenderRanges(c.dateProfile.renderUnzonedRange, p.calendar)))
                        },
                        hitOut: function() {
                            r = null
                        },
                        ...
                        interactionEnd: function(t) {
                            r && p.reportExternalDrop(r, Boolean(h.eventProps), Boolean(h.stick), e, t, n), d.isDragging = !1, d.dragListener = null
                        }
                    })).startDrag(t)
                ...
                return r.__extends(t, i), t.prototype.end = function() {
                    ...
                    return this.dragListener = new s.default(c, {
                        ...
                        hitOver: function(t, e, n) {
                            ...
                            o && s ? (u = l ? d.computeEventStartResizeMutation(o, s, a.footprint) : d.computeEventEndResizeMutation(o, s, a.footprint)) ? (i = f.buildMutatedEventInstanceGroup(g.id, u), r = c.isEventInstanceGroupAllowed(i)) : r = !1 : r = !1, r ? u.isEmpty() && (u = null) : (u = null, v.disableCursor()), u && (p.hideEventsWithId(a.footprint.eventDef.id), p.renderEventResize(c.eventRangesToEventFootprints(i.sliceRenderRanges(c.dateProfile.renderUnzonedRange, h)), a))
                        },
                        hitOut: function() {
                            u = null
                        },
            ...
            i = function(i) {
                ...
                return r.__extends(t, i), t.prototype.end = function() {
                    ...
                    var v = this.dragListener = new m.default(p, {
                        ...
                        hitOver: function(t, e, n) {
                            var i, r, o, s = !0;
                            a.hit && (n = a.hit), i = n.component.getSafeHitFootprint(n), r = t.component.getSafeHitFootprint(t), i && r ? (u = d.computeEventDropMutation(i, r, g)) ? (o = f.buildMutatedEventInstanceGroup(g.id, u), s = c.isEventInstanceGroupAllowed(o)) : s = !1 : s = !1, s || (u = null, y.disableCursor()), u && p.renderDrag(c.eventRangesToEventFootprints(o.sliceRenderRanges(c.dateProfile.renderUnzonedRange, h)), a, v.isTouch) ? l.hide() : l.show(), e && (u = null)
                        },
                        hitOut: function() {
        ...
        (e.default = f).prototype.timeGridClass = p.default, f.prototype.dayGridClass = h.default, i = {
            ...
            i = function(i) {
                ...
                return r.__extends(t, i), t.prototype.renderBgRanges = function(t) {
                    ...
                    var i, r, o, s, a, l, u, d = this.dayGrid.colCnt,
                        ...
                        v = [];
                    for (i = 0; i < p; i++) {
                        if (r = c[i], o = 0, s = y("<tr/>"), f.push([]), g.push([]), v.push([]), r)
                        ...
                        n(d), this.dayGrid.bookendCells(s), h.append(s)
                    }
                    return {
                        row: t,
                        tbodyEl: h,
