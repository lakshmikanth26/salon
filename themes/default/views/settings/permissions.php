                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <input type="checkbox" value="1" class="checkbox"
                                               name="staffs-index" <?php echo $p->{'staffs-index'} ? "checked" : ''; ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="checkbox" value="1" class="checkbox"
                                               name="staffs-add" <?php echo $p->{'staffs-add'} ? "checked" : ''; ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="checkbox" value="1" class="checkbox"
                                               name="staffs-edit" <?php echo $p->{'staffs-edit'} ? "checked" : ''; ?>>
                                    </td>
                                    <td class="text-center">
                                        <input type="checkbox" value="1" class="checkbox"
                                               name="staffs-delete" <?php echo $p->{'staffs-delete'} ? "checked" : ''; ?>>
                                    </td>
                                    <td>
                                    </td>
                                </tr>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0"
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <input type="checkbox" value="1" class="checkbox" id="staffs"
                                               name="reports-staffs" <?php echo $p->{'reports-staffs'} ? "checked" : ''; ?>><label
                                            for="staffs" class="padding05"><?= lang('staffs') ?></label>
                                    </td>
                                </tr>
                                </thead>
                            </table>
