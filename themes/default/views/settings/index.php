        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <?= lang("default_bill", "default_bill"); ?>
                            <?php
                            $bl[""] = "";
                            foreach ($invoice_types as $invoice_type) {
                                $ino[$invoice_type->id] = $invoice_type->name;
                            }
                            echo form_dropdown('default_bill', $ino, (isset($_POST['default_bill']) ? $_POST['default_bill'] : $Settings->default_bill), 'id="default_bill" data-placeholder="' . lang("select") . ' ' . lang("default_bill") . '" required="required" class="form-control input-tip select" style="width:100%;"');
                            ?>
                        </div>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <?= lang("default_bank_detail", "bank_detail"); ?>
                            <?php
                            $bd[""] = "";
                            foreach ($bank_details as $bank_detail) {
                                $bd[$bank_detail->id] = $bank_detail->bank_name;
                            }
                            echo form_dropdown('bank_detail', $bd, (isset($_POST['bank_detail']) ? $_POST['bank_detail'] : $Settings->default_bank_detail), 'id="bank_detail" data-placeholder="' . lang("select") . ' ' . lang("bank_detail") . '" required="required" class="form-control input-tip select" style="width:100%;"');
                            ?>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <?= lang("default_staff", "staff"); ?>
                            <?php
                            $st[""] = "";
                            foreach ($staffs as $staff) {
                                $st[$staff->id] = $staff->company != '-' ? $staff->company.' - '.$staff->name : $staff->name;
                            }
                            echo form_dropdown('staff', $st, (isset($_POST['staff']) ? $_POST['staff'] : $Settings->default_staff), 'id="staff" data-placeholder="' . lang("select") . ' ' . lang("staff") . '" required="required" class="form-control input-tip select" style="width:100%;"');
                            ?>
                        </div>
                    </div>
