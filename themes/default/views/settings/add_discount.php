        ...
        <div class="modal-body row">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <div
                        class="controls"> <?php echo form_input('price_for_value', "", 'class="form-control" id="price_for_value" required="required"'); ?> </div>
                </div>
            </div>
            ...
            <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <?= form_input('start_date', "", 'class="form-control date" id="start_date" required="required"'); ?>
                        </div>
                    </div>
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <?= lang("end date", "date"); ?>
                    <?= form_input('end_date', "", 'class="form-control date" id="expiry_date" required="required"'); ?>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="form-group">
