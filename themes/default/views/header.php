        ...
        <div class="container">
            ...
            <div class="btn-group visible-xs pull-right btn-visible-sm">
                ...
                <?php if (POS) { ?>
                    ...
                    <a class="btn" title="<?= lang('pos') ?>" data-placement="left" href="<?= site_url('pos') ?>"><i class="fa fa-th-large"></i> <span class="padding05"><?= lang('pos') ?></span></a>

                    <?php if ($Owner) { ?>
                        
                        <a class="btn" id="today_profit" title="<span><?= lang('today_profit') ?></span>" data-placement="bottom" data-html="true" href="<?= site_url('pos/today_profit') ?>" data-toggle="modal" data-target="#myModal"><i class="fa fa-hourglass-2"></i></a>
                ...
                <?php if ($Owner || $Admin) { ?>
                    ...
                    <a class="btn" title="<?= lang('list_open_registers') ?>" data-placement="bottom" href="<?= site_url('pos/registers') ?>"><i class="fa fa-list"></i></a>

                    <?php } ?>

                    <a class="btn" title="<?= lang('clear_ls') ?>" data-placement="bottom" id="clearLS" href="#"><i class="fa fa-eraser"></i></a>
            ...
            <div class="header-nav">
                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <?php if (($Owner || $Admin) && ($qty_alert_num > 0 || $exp_alert_num > 0 || $appointment_alert_num > 0)) { ?>
                        ...
                        <li class="dropdown hidden-sm">
                            ...
                            <ul class="dropdown-menu pull-right">
                                ...
                                <li>
                                    ...
                                    <a href="<?= site_url('welcome/appointment') ?>" class="">

                                        <span class="label label-danger pull-right" style="margin-top:3px;"><?= $appointment_alert_num; ?></span>

                                        <span style="padding-right: 35px;"><?= lang('Appointment_alerts') ?></span>
            ...
            <div id="sidebar-left" class="col-lg-2 col-md-2">
                ...
                <div class="sidebar-nav nav-collapse collapse navbar-collapse" id="sidebar_menu">
                    ...
                    <ul class="nav main-menu">
                        ...
                        <li class="mm_appointment"><a href="<?= site_url('welcome/appointment') ?>"><i class="fa fa-dashboard"></i><span

                                    class="text"> <?= lang('Appointments'); ?></span><span class="label label-danger pull-right" style="margin-top:13px;margin-right:10px;"><?= $appointment_alert_num; ?></span></a></li>
                        ...
                        if ($Owner || $Admin) {
                            ...
                            <li class="mm_services">
                                ...
                                <a class="dropmenu" href="#"><i class="fa fa-barcode"></i><span
                                        ...
                                        class="text"> <?= lang('services'); ?> </span> <span

                                        class="chevron closed"></span></a>

                                <ul>

                                    <li id="services_index"><a class="submenu" href="<?= site_url('services'); ?>"><i

                                                class="fa fa-barcode"></i><span

                                                class="text"> <?= lang('list_services'); ?></span></a></li>            
                                    
                                    <!-- <li id="services_add"><a class="submenu" href="<?= site_url('services/add'); ?>"><i

                                                class="fa fa-plus-circle"></i><span

                                                class="text"> <?= lang('add_service'); ?></span></a></li> -->
                            ...
                            <li class="mm_sales <?= strtolower($this->router->fetch_method()) == 'settings' ? '' : 'mm_pos' ?>">
                                ...
                                <ul>
                                    ...
                                    <?php if (POS) { ?>
                                        ...
                                        <li id="pos_sales_bill"><a class="submenu" href="<?= site_url('pos/sales_bill'); ?>"><i

                                                    class="fa fa-heart"></i><span

                                                    class="text"> <?= lang('pos_sales_cash'); ?></span></a></li> 
                                    ...
                                    <li id="payments_Pindex"><a class="submenu"

                                                                   href="<?= site_url('sales/Pindex'); ?>"><i

                                                class="fa fa-reply"></i><span

                                                class="text"> <?= lang('payments').'('.$pending_count.')'; ?></span></a></li>
                            ...
                            <li class="mm_auth mm_customers mm_suppliers mm_billers">
                                ...
                                <ul>
                                    ...
                                    <li id="staffs_index"><a class="submenu" href="<?= site_url('staffs'); ?>"><i

                                                class="fa fa-users"></i><span

                                                class="text"> <?= lang('list_staffs'); ?></span></a></li>

                                    <li id="staffs_index"><a class="submenu" href="<?= site_url('staffs/add'); ?>"

                                                                data-toggle="modal" data-target="#myModal"><i

                                                class="fa fa-plus-circle"></i><span

                                                class="text"> <?= lang('add_staff'); ?></span></a></li>            
                            ...
                            <?php if ($Owner) { ?>
                                ...
                                <li class="mm_system_settings <?= strtolower($this->router->fetch_method()) != 'settings' ? '' : 'mm_pos' ?>">
                                    ...
                                    <ul>
                                        ...
                                        <li id="system_settings_per_types"><a

                                                href="<?= site_url('system_settings/per_types') ?>"><i

                                                    class="fa fa-book"></i><span

                                                    class="text"> <?= lang('per_types'); ?></span></a></li>

                                        <li id="system_settings_bank_details"><a

                                                href="<?= site_url('system_settings/bank_details') ?>"><i

                                                    class="fa fa-book"></i><span

                                                    class="text"> <?= lang('bank_details'); ?></span></a></li>
                                        ...
                                        <li id="system_settings_sms_template"><a

                                                href="<?= site_url('system_settings/sms_templates') ?>"><i

                                                    class="fa fa-phone"></i><span

                                                    class="text"> <?= lang('sms_templates'); ?></span></a></li>
                            ...
                            <li class="mm_reports">
                                ...
                                <ul>
                                    ...
                                    <li id="reports_staffs"><a href="<?= site_url('reports/staffs') ?>"><i

                                                class="fa fa-users"></i><span

                                                class="text"> <?= lang('staffs_report'); ?></span></a></li>
            

                                    <li id="reports_user_report"><a href="<?= site_url('reports/users') ?>"><i

                                                class="fa fa-users"></i><span

                                                class="text"> <?= lang('user_report'); ?></span></a></li>
                        ...
                        <?php
                            ...
                            <?php if ($GP['products-index']) { ?>
                                ...
                                <li class="mm_services">
                                    ...
                                    <ul>
                                        ...
                                        <li id="services_index"><a class="submenu"

                                                                   href="<?= site_url('services'); ?>"><i
                                        ...
                                        <?php if ($GP['products-add']) { ?>
                                            ...
                                            <!-- <li id="services_add"><a class="submenu"

                                                                     href="<?= site_url('services/add'); ?>"><i
                                ...
                                <li class="mm_sales <?= strtolower($this->router->fetch_method()) == 'settings' ? '' : 'mm_pos' ?>">
                                    ...
                                    <ul>
                                        ...
                                        <li id="payments_Pindex"><a class="submenu"
                                                ...
                                                class="text"> <?= lang('payments'); ?></span></a></li>
                            ...
                            <?php if ($GP['customers-index'] || $GP['suppliers-index'] || $GP['staffs-index']) { ?>
                                ...
                                <li class="mm_auth mm_customers mm_suppliers mm_billers">
                                    ...
                                    <ul>
                                        ...
                                        if ($GP['staffs-index']) { ?>
                                            ...
                                            <li id="staffs_index"><a class="submenu"

                                                                        href="<?= site_url('staffs'); ?>"><i
                            ...
                            <?php if ($GP['reports-quantity_alerts'] || $GP['reports-expiry_alerts'] || $GP['reports-products'] || $GP['reports-monthly_sales'] || $GP['reports-sales'] || $GP['reports-payments'] || $GP['reports-purchases'] || $GP['reports-customers'] || $GP['reports-suppliers']) { ?>
                                ...
                                <li class="mm_reports">
                                    ...
                                    <ul>
                                        ...
                                        <?php } 
                                        if ($GP['reports-staffs']) { ?>

                                            <li id="reports_staff_report"><a

                                                    href="<?= site_url('reports/staffs') ?>"><i
