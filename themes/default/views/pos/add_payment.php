                ...
                <div class="well well-sm well_1">
                    <div class="col-md-12">
                        ...
                        <div class="pneft_1" style="display:none;">
                                    <div class="form-group">
                                        <input name="pneft_no" type="text" id="pneft_no_1" class="form-control"
                                               placeholder="<?= lang('neft_no') ?>"/>
                                    </div>
                         </div>
                        <div class="ppaytm_1" style="display:none;">
                                    <div class="form-group">
                                        <input name="ppaytm_no" type="text" id="ppaytm_no_1" class="form-control"
                                               placeholder="<?= lang('paytm_no') ?>"/>
                                    </div>
                         </div>
                        <div class="pbajaj_1" style="display:none;">
                                    <div class="form-group">
                                        <input name="pbajaj_no" type="text" id="pbajaj_no_1" class="form-control"
