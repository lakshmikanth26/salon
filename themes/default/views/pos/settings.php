            ...
            <div class="col-lg-12">
                ...
                <fieldset class="scheduler-border">
                    ...
                    <div class="col-md-4 col-sm-4">
                        ...
                        <div class="form-group">
                            <?= lang('default_staff', 'default_staff'); ?>
                            <?php
                            $sf[0] = "";
                            foreach ($staffs as $staff) {
                                $sf[$staff->id] = $staff->name;
                            }
                            ...
                            echo form_dropdown('staff', $sf, $pos->default_staff, 'class="form-control select" id="default_staff" required="required"');
                            ?>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4">
