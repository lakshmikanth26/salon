        ...
        <div class="container">
            ...
            <div class="header-nav">
                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <?php } ?>
                    <li class="dropdown hidden-xs">
                        <a class="btn blightOrange tip" href="<?= site_url('welcome/information'); ?>" title="<?= lang('help') ?>"
                                                                data-toggle="modal" data-target="#myModal">HelpDesk</a></li>
                ...
                <div id="pos">
                    ...
                    <div id="leftdiv">
                            ...
                            <div
                                style="position: absolute; <?= $Settings->rtl ? 'right:-9999px;' : 'left:-9999px;'; ?>"><?php echo form_input('test', '', 'id="test" class="kb-pad"'); ?></div>
                                    ...
                                    <div class="form-group col-md-3">
                                        <?php
                                        $bil[''] = '';
                                        foreach ($invoice_types as $bill) {
                                            $bil[$bill->id] = $bill->name;
                                        }
                                        echo form_dropdown('invoice_type', $bil, (isset($_POST['invoice_type']) ? $_POST['invoice_type'] : $Settings->default_bill), 'id="posinvoice_type" class="form-control pos-input-tip" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("invoice type") . '" required="required" style="width:100%;" ');
                                        ?>
                                    </div>
                        ...
                        <div id="print">
                                ...
                                <div id="product-list">
                                    <table class="table items table-striped table-bordered table-condensed table-hover"
                                        ...
                                        <tr>
                                            ...
                                            <th width="15%" colspan="2"><?= lang("subtotal"); ?><br>M &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Non
                            ...
                            <div id="left-bottom">
                                <table id="totalTable"
                                       style="width:100%; float:right; padding:2px; color:#000; background: #FFF;">
                                    <tr>
                                        <td colspan="2" style="padding: 2px 2px;font-weight:bold;">    
                                            <a class="btn btn-warning" href="#" id="ppcoupon">
                                                <?= lang('Coupon_Discount'); ?> <i class="fa fa-edit"></i>
                                            </a>
                                            <span id="poscoupon_name" style="color:red;"></span>
                                        
                                        </td>
                                        
                                        <td style="padding: 2px 2px;font-weight:bold;"><?= lang('Qty'); ?></td>
                                        <td class="text-right" style="padding: 2px 2px;font-size: 16px; font-weight:bold;">
                                            <span id="titems">0</span>
                                        </td>
                                        <td style="padding: 2px 2px;font-weight:bold;"><?= lang('total'); ?></td>
                                        <td class="text-right" style="padding: 2px 2px;font-size: 16px; font-weight:bold;">
                                            <span id="total">0.00</span>
                                            <input type="hidden" id="totaltext" value="0.00" name="totaltext">
                                            <input type="hidden" id="totalnontext" value="0.00" name="totalnontext">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td colspan="3" style="padding: 2px 2px;">
                                            <a class="btn btn-success" href="#" id="ppdiscount">
                                                <?= lang('Offer_Discount'); ?> <i class="fa fa-edit"></i>
                                            </a>
                                            <span id="posdiscount_name" style="color:red;"></span>
                                        
                                        </td>
                                        <td class="text-right" style="padding: 2px 2px;font-weight:bold;font-size: 16px;">
                                            <span id="tds">0.00</span>
                                        </td>
                                        <td style="padding: 2px 2px;font-weight:bold;"><?= lang('tax'); ?>
                                        </td>
                                        <td class="text-right" style="padding: 2px 2px;font-weight:bold;font-size: 16px;">
                                            <span id="tax_total">0.00</span>
                                            <input type="hidden" id="taxtext" value="0.00" name="taxtext">
                                            <input type="checkbox" name="pptaxsummory" value='1' checked="checked" style="display: none;">
                                        
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="5" style="padding: 5px 10px; border-top: 1px solid #666; font-weight:bold; background:#333; color:#FFF; font-size: 20px; text-transform: uppercase;">
                                            <?= lang('total_payable'); ?>
                                        </td>
                                        <td class="text-right" style="padding:5px 10px 5px 10px; font-size: 20px;border-top: 1px solid #666; font-weight:bold; background:#333; color:#FFF;" colspan="2">
                                            <span id="gtotal">0.00</span>
                                            <input type="hidden" id="gtotaltext" value="0.00" name="gtotaltext">
                                            <input type="hidden" id="non_gtotal" value="0.00" name="non_gtotal">
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <div id="botbuttons" style="text-align:center;">
                                    ...
                                    <input type="hidden" name="service_no" id="service_no" required="required"/>
                                ...
                                <div id="payment-con">
                                    <?php for ($i = 1; $i <= 5; $i++) { ?>
                                        ...
                                        <input type="hidden" name="bajaj_no[]" id="bajaj_no_val_<?= $i ?>" value=""/>
                                        <input type="hidden" name="neft_no[]" id="neft_no_val_<?= $i ?>" value=""/>
                                        <input type="hidden" name="paytm_no[]" id="paytm_no_val_<?= $i ?>" value=""/>
                        ...
                        <div id="cpinner">
                            ...
                            <div class="quick-menu">
                                <div id="proContainer">
                                    <div id="ajaxproducts">
                                    	<div class="item-list">
                                    		<div class='item-list-wallets'></div>
                                    		<div class='item-list-appointements'></div>
                                    	</div>
                                        <!-- <div id="item-list">
                                            <?php echo $products; ?>
                                        </div>
            ...
            <div class="modal-body" id="payment_content">
                <div class="row">
                    <div class="col-md-10 col-sm-9">
                        ...
                        ?>
                        <div class="form-group">
                            <?= lang("service_no", "service_no"); ?>
                            <?php echo form_input('posservice_no', '', 'class="form-control" id="posservice_no" required="required"'); ?>
                        </div>
                                ...
                                <div class="payment">
                                        ...
                                        <div class="col-sm-5 col-sm-offset-1">
                                            <div class="form-group">
                                                ...
                                                <select name="paid_by[]" id="paid_by_1" class="form-control paid_by">
                                                    ...
                                                    <option value="BAJAJ"><?= lang("bajaj_finserv"); ?></option>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-11">
                                            ...
                                            <div class="pbajaj_1" style="display:none;">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <input name="bajaj_no[]" type="text" id="pbajaj_no_1"
                                                                   class="form-control"
                                                                   placeholder="<?= lang('bajaj_no') ?>"/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="pneft_1" style="display:none;">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <input name="neft_no[]" type="text" id="pneft_no_1"
                                                                   class="form-control"
                                                                   placeholder="<?= lang('neft_no') ?>"/>
                                                        </div>
                                                    </div>
                                                    
                                                </div>
                                            </div>
                                            <div class="ppaytm_1" style="display:none;">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <input name="paytm_no[]" type="text" id="ppaytm_no_1"
                                                                   class="form-control"
                                                                   placeholder="<?= lang('paytm_no') ?>"/>
                                                        </div>
                                                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="pr_popover_content">
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        <label for="mhsn_sac" class="col-sm-4 control-label"><?= lang('hsn_sac') ?> *</label>

                        <div class="col-sm-8">
                            <input type="text" class="form-control kb-text" id="mhsn_sac">
                        </div>
                    </div>
                    <?php if ($Settings->tax1) { ?>
                        <div class="form-group">
                    ...
                    <div class="form-group">
                            <label for="mper_type" class="col-sm-4 control-label"><?= lang('per_types') ?> *</label>

                            <div class="col-sm-8">
                                <?php
                                $per[""] = "";
                                foreach ($per_types as $per_type) {
                                    $per[$per_type->id] = $per_type->name;
                                }
                                echo form_dropdown('mper_type', $per, "", 'id="mper_type" class="form-control pos-input-tip" style="width:100%;"');
                                ?>
                            </div>
                        </div>
                    <?php if ($Settings->product_discount) { ?>
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    foreach ($discounts as $discount) {
                        $dis[$discount->id] = $discount->name;
                    }
                    echo form_dropdown('discount_id', $dis, "", 'id="discount_id" class="form-control pos-input-tip" style="width:100%;"');
                    ?>
                </div>
...
<div class="modal fade in" id="couponModal" tabindex="-1" role="dialog" aria-labelledby="couponModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i
...
<script type="text/javascript">
    var product_variant = 0, shipping = 0, p_page = 0, per_page = 0, tcp = "<?= $tcp ?>",
        ...
        product_tax = 0, invoice_tax = 0, total_discount = 0, total = 0, invoice_tax_final = 0, total_final = 0, total_paid = 0, grand_total = 0,
    ...
    function widthFunctions(e) {
        ...
        $('#item-list1').css("height", wh - 140);
        $('#item-list1').css("min-height", 515);
    ...
    $(document).ready(function () {
        ...
        if (localStorage.getItem('posstaff')) {
            localStorage.removeItem('posstaff');
        }
        ...
        localStorage.setItem('poscoupon', '<?=$suspend_sale->coupon_discount_id;?>');
        ...
        localStorage.setItem('posstaff', '<?=$suspend_sale->staff_id;?>');
        <?php } ?>
            ...
            initSelection: function (element, callback) {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        data[0].whatsapp+"</p>"+(customerGroupName.toLowerCase() == "member" ? "<b><p>Membership Start Date : " +
                        data[0].cf1 + "</p></b>" : "") + (customerGroupName.toLowerCase() == "member" ? "<b><p>Membership End Date : " +
                        data[0].cf2 + "</p></b>" : "") + (customerGroupName.toLowerCase() == "member" ? "<b><p>Expires In : " + data[0].expiresIn + " Days</p></b>" :"") + "<br><a class='btn btn-success' style='width:100%' href='"+site.base_url+
                        "customers/edit/"+data[0].id+"' data-toggle='modal' data-target='#myModal'>Edit</a><div class='item-list-sales row'></div><div class='item-customer-list-sales'></div><div class='item-list-coupons'></div></div>");
                        ...
                        $.ajax({
                            ...
                            success: function (res) {
                                if (res.results != null) {
                                    ...
                                    $("#item-list1").html("<div><p>Name : "+res.results.text+"</p><p>Phone : "+res.results.phone+"</p><p>Customer : "+res.results.customer_group_name+"</p><a href='"+site.base_url+"customers/edit/"+res.results.id+"' data-toggle='modal' data-target='#myModal'>Edit</a></div>");
        ...
        $(document).on('change', '#posservice_no', function () {
            $('#service_no').val($(this).val());
        });
        $(document).on('change', '#posstaff', function () {
            $('#staff').val($(this).val());
        });
        <?php for($i=1; $i<=5; $i++) { ?>
        ...
        $('#paymentModal').on('change', '#pbajaj_no_<?=$i?>', function (e) {
            $('#bajaj_no_val_<?=$i?>').val($(this).val());
        });
        $('#paymentModal').on('change', '#pneft_no_<?=$i?>', function (e) {
            $('#neft_no_val_<?=$i?>').val($(this).val());
        });
        $('#paymentModal').on('change', '#ppaytm_no_<?=$i?>', function (e) {
            $('#paytm_no_val_<?=$i?>').val($(this).val());
        });
        ...
        $('#payment').click(function () {
            ...
            var twt = formatDecimal((total_final + invoice_tax_final) - order_discount - coupon_discount);
            if (count == 1) {
        ...
        $(document).on('change', '.paid_by', function () {
            ...
            }else if (p_val == 'Wallet') { 

            	$.ajax({
                    type: "get", async: false,
                    url: site.base_url + "customers/get_award_points/" + localStorage.getItem('poscustomer'),
                    dataType: "json",
                    success: function (data) {
                        if (data === false) {
                        	
                        } else {
                            $('#amount_' + pa_no).val(data.ca_points).focus();
                        }
                    }
                });
            } else {
