...
<div id="wrapper">
    ...
    <div id="receipt-data">
        ...
        <div class="text-center">
            ...
            echo "<p>Bill No: " . $inv->reference_no . "<br>";
            echo "<p>Service No: " . $inv->service_no . "<br>";
            ...
            <thead>
                ...
                <tr>
                    <td colspan="1"><?php echo lang("staff"); ?></td>
                ...
                foreach ($rows as $row) {
                    ...
                    foreach($staffs as $staff):
                        ...
                        if($row->product_id == $staff->product_id){

                            if($row->sale_item_id == $staff->sale_item_id){
                    ...
                    echo '<td colspan="2">' . product_name($row->product_name) . ($row->variant ? ' (' . $row->variant . ')' : '') . '</td>';
                ...
                <tr>
                    ...
                    <th colspan="2"><?= $this->sma->formatMoney($inv->total + $inv->product_tax); ?></th>

                    <?php } else { ?>

                    <th><?= $this->sma->formatMoney($inv->total); ?></th>
                ...
                if ($inv->order_tax != 0) {
                    ...
                    echo '<tr><th colspan="6">' . lang("tax") . '</th><th class="text-right">' . $this->sma->formatMoney($inv->order_tax) . '</th></tr>';

                }

                if ($inv->order_discount != 0) {
                    if(!empty($discount->name)){
                        echo '<tr><th colspan="6">' . lang("order_discount") .'('.$discount->name. ')</th><th class="text-right">'.$this->sma->formatMoney($inv->order_discount) . '</th></tr>';
                        }else{
                         echo '<tr><th colspan="6">' . lang("order_discount") .'</th><th class="text-right">'.$this->sma->formatMoney($inv->order_discount) . '</th></tr>';
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <th colspan="6"><?= lang("grand_total"); ?></th>
                ...
                <?php if($customer_group->id == 5){ ?>
                    <tr style="border-top: 2px solid #000;">
                        ...
                        <th colspan="6"><?= lang("Non_Member_Price"); ?></th>

                        <th class="text-right"><?= $this->sma->formatMoney($inv->non_member_price); ?></th>

                    </tr>
                    <tr>

                        <th colspan="6"><?= lang("Your_Save"); ?></th>

                        <th class="text-right"><?= $this->sma->formatMoney($inv->non_member_price - $inv->grand_total); ?></th>
