<script>
    $(document).ready(function () {
        var oTable = $('#POSData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('pos/getSalesBill'.($warehouse_id ? '/'.$warehouse_id : '')) ?>',
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-barcode"></i><?= lang('pos_sales_cash') . ' (' . ($warehouse_id ? $warehouse->name : lang('all_warehouses')) . ')'; ?>
        </h2>
