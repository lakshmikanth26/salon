...
<ul id="myTab" class="nav nav-tabs">
    <li class=""><a href="#daily-con" class="tab-grey"><?= lang('user_daily_sales') ?></a></li>
    <li class=""><a href="#monthly-con" class="tab-grey"><?= lang('user_monthly_sales') ?></a></li>
    <li class=""><a href="#sales-con" class="tab-grey"><?= lang('user_sales_report') ?></a></li>
    <li class=""><a href="#purchases-con" class="tab-grey"><?= lang('user_purchases_report') ?></a></li>
    <li class=""><a href="#payments-con" class="tab-grey"><?= lang('user_payments_report') ?></a></li>
    <li class=""><a href="#logins-con" class="tab-grey"><?= lang('user_logins_report') ?></a></li>
</ul>
