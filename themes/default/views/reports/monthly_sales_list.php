...
<script>
    $(document).ready(function () {
        var oTable = $('#SlRData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('reports/getMonthlySalesListReport/?v=1' . $v) ?>',
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-heart"></i><?= lang('monthly_sales_report'); ?> </h2>
        <div class="box-icon">
            <ul class="btn-tasks">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo form_open("reports/monthly_sales_list/".$year."/".$month); ?>
                    <div class="row">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=site_url('reports/getMonthlySalesListReport/pdf/?v=1'.$v)?>";
            return false;
        });
    // $(document).ready(function () {
    //     $('#pdf').click(function (event) {
    ...
    //     });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=site_url('reports/getMonthlySalesListReport/0/xls/?v=1'.$v)?>";
            return false;
        });
