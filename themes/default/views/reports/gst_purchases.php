...
<script type="text/javascript">
    $(document).ready(function () {
        var oTable = $('#PoRData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('reports/getGSTPurchasesReport/?v=1' . $v) ?>',
            ...
            "aoColumns": [{"mRender": fld}, null, null, null,{"bSearchable": false,"mRender": pqFormat}, {"mRender": currencyFormat},null,{"mRender": currencyFormat},{"mRender": currencyFormat}],
            "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                var gtotal = 0, paid = 0, balance = 0, total = 0, total_tax = 0;
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo form_open("reports/gst_purchases"); ?>
                    <div class="row">
                        <div class="col-sm-4">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=site_url('reports/getGSTPurchasesReport/pdf/?v=1'.$v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=site_url('reports/getGSTPurchasesReport/0/xls/?v=1'.$v)?>";
            return false;
        });
