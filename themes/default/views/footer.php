                        ...
                        <form class="form-event" action="javascript:;">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input type="text" class="form-control add_event_mobile_no" id="add_event_mobile_no"  required="required" name="add_event_mobile_no" placeholder="Mobile Number" autocomplete="false">

                                </div>

                            </div>

                            <div class="form-group row contact_details" style="display:none;">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group m-0">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control"  required="required" id="add_event_name" name="add_event_name" placeholder="Name" autocomplete="false">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group row m-0">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control"  id="add_event_email" name="add_event_email" placeholder="Email" autocomplete="false">
            ...
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title" id="exampleModalLabel2">Edit Appointment</h5>
