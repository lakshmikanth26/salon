    ...
    $(document).ready(function () {
        ...
        var oTable = $('#EXPData').dataTable({
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, {"mRender": fld}, null,null,null, {"mRender": currencyFormat},{"mRender": currencyFormat},{"mRender": currencyFormat}, null, null, {
                "bSortable": false,
                "mRender": attachment
            }, {"bSortable": false}],
            ...
            "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                ...
                nCells[5].innerHTML = currencyFormat(cost);
            ...
            {column_number: 4, filter_default_label: "[<?=lang('gst_no');?>]", filter_type: "text", data: []},
                ...
                <div class="table-responsive">
                    <table id="EXPData" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr class="active">
                            ...
                            <th class="col-xs-1"><?php echo $this->lang->line("reference"); ?></th>
                            <th class="col-xs-1"><?php echo $this->lang->line("company_name"); ?></th>
                            <th class="col-xs-1"><?php echo $this->lang->line("gst_no"); ?></th>
                            <th class="col-xs-1"><?php echo $this->lang->line("cost"); ?></th>
                            <th class="col-xs-1"><?php echo $this->lang->line("gst"); ?></th>
