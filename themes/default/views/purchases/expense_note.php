            ...
            <div class="well">
                <table class="table table-borderless" style="margin-bottom:0;">
                    ...
                    <tr>
                        ...
                        <td><strong class="text-right"><?php echo $expense->company_name; ?></strong></td>
                    </tr>
                    <tr>
                        <td><strong><?= lang("gst_no"); ?></strong></td>
                        <td><strong class="text-right"><?php echo $expense->gst_no; ?></strong></td>
                    </tr>
                    <tr>
                        <td><strong><?= lang("cost"); ?></strong></td>
                        <td><strong class="text-right"><?php echo $this->sma->formatMoney($expense->cost); ?></strong>
                        </td>
                    </tr>
                    <tr>
                        <td><strong><?= lang("gst"); ?></strong></td>
                        <td><strong class="text-right"><?php echo $this->sma->formatMoney($expense->tax_amount); ?></strong>
                        </td>
                    </tr>
                    <tr>
