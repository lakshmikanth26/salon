<script type="text/javascript">
    ...
    $(document).ready(function () {
        if (localStorage.getItem('remove_slls')) {
            ...
            if (localStorage.getItem('slbank')) {
                localStorage.removeItem('slbank');
            }
            if (localStorage.getItem('slstaff')) {
                localStorage.removeItem('slstaff');
            }
            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-12">    
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    echo form_dropdown('staff', $st, (isset($_POST['staff']) ? $_POST['staff'] : $Settings->default_staff), 'id="slstaff" class="form-control input-tip select" data-placeholder="' . lang("select") . ' ' . lang("staff") . '" required="required" style="width:100%;" ');
                                    ?>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?= lang("bank_details", "slbank"); ?>
                                    <?php
                                    $bd[''] = '';
                                    foreach ($bank_details as $bank_detail) {
                                        $bd[$bank_detail->id] = $bank_detail->bank_name;
                                    }
                                    echo form_dropdown('bank_detail', $bd, (isset($_POST['bank_detail']) ? $_POST['bank_detail'] : $Settings->default_bank_detail), 'id="slbank" class="form-control input-tip select" data-placeholder="' . lang("select") . ' ' . lang("bank_details") . '" required="required" style="width:100%;" ');
                                    ?>
                                </div>
                            </div>
                        </div>        
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <?= lang("po_ref", "slpo_ref"); ?>
                                <?php echo form_input('po_ref', '', 'class="form-control tip" data-trigger="focus" data-placement="top" title="' . lang('po_ref_tip') . '" id="slpo_ref"'); ?>

                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <?= lang("supplier_ref", "slsupplier_ref"); ?>
                                <?php echo form_input('supplier_ref', '', 'class="form-control tip" data-trigger="focus" data-placement="top" title="' . lang('supplier_ref_tip') . '" id="slsupplier_ref"'); ?>

                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <?= lang("dispatched_throw", "sldispatched_throw"); ?>
                                <?php echo form_input('dispatched_throw', '', 'class="form-control tip" data-trigger="focus" data-placement="top" title="' . lang('dispatched_throw_tip') . '" id="sldispatched_throw"'); ?>
            ...
            <div class="modal-body" id="pr_popover_content">
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="mhsn_sac">
                        </div>
                    </div>
                    <?php if ($Settings->tax1) { ?>
                        <div class="form-group">
                    ...
                    <div class="form-group">
                            <label for="mtax" class="col-sm-4 control-label"><?= lang('per_type') ?> *</label>
                            ...
                            <div class="col-sm-8">
                                ...
                                echo form_dropdown('mper_type', $per, "", 'id="mper_type" class="form-control input-tip select" style="width:100%;"');
                                ?>
                            </div>
                        </div>
                    <?php if ($Settings->product_discount) { ?>
