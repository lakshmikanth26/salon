<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        localStorage.setItem('slstaff', '<?= $inv->staff_id ?>');
        localStorage.setItem('slbank', '<?= $inv->bank_id ?>');
        ...
        localStorage.setItem('slpo_ref', '<?= $inv->po_ref ?>');
        localStorage.setItem('slsupplier_ref', '<?= $inv->supplier_ref ?>');
        localStorage.setItem('sldispatched_throw', '<?= $inv->dispatched_throw ?>');
                        ...
                        <div class="col-md-12">    
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    echo form_dropdown('staff', $st, (isset($_POST['staff']) ? $_POST['staff'] : $inv->staff_id), 'id="slstaff" class="form-control input-tip select" data-placeholder="' . lang("select") . ' ' . lang("staff") . '" required="required" style="width:100%;" ');
                                    ?>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    echo form_dropdown('bank_detail', $bd, (isset($_POST['bank_detail']) ? $_POST['bank_detail'] : $inv->bank_id), 'id="slbank" class="form-control input-tip select" data-placeholder="' . lang("select") . ' ' . lang("bank_details") . '" required="required" style="width:100%;" ');
                                    ?>
                                </div>
                            </div>
                        </div>                         
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="pr_popover_content">
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                            <label for="mper_type" class="col-sm-4 control-label"><?= lang('per_type') ?> *</label>
