                        ...
                        <div class="col-md-12">
                            ...
                            <div class="well well-sm">
                                ...
                                <?php echo $this->lang->line("csv2"); ?> <span
                                    class="text-info">( <?= lang("product_code") . ', ' . lang("net_unit_price") . ', ' . lang("quantity") . ', ' . lang("product_variant") . ', ' . lang("tax_rate_name") . ', ' . lang("discount") . ', ' . lang("serial_no"). ', ' . lang("hsn_sac"). ', ' . lang("per_type"); ?> )</span> <?php echo $this->lang->line("csv3"); ?><br>
