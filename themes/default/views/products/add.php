...
<script type="text/javascript">
    $(document).ready(function () {
        $( "#hsn_sac" ).autocomplete({
            source: "<?= site_url('products/getHSN_SAC') ?>"
        });
            ...
            <div class="col-lg-12">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group all">
                        <label class="control-label" for="hsn_sac"><?= lang("HSN/SAC") ?></label>
                        <?= form_input('hsn_sac', (isset($_POST['hsn_sac']) ? $_POST['hsn_sac'] : ($product ? $product->hsn_sac : '')), 'class="form-control tip" id="hsn_sac" required="required"') ?>
                    </div>
                    <div class="form-group all">
                    ...
                    <div class="form-group standard">
                        ...
                        <?= form_input('cost', (isset($_POST['cost']) ? $_POST['cost'] : ($product ? $this->sma->formatDecimal($product->cost) : '')), 'class="form-control tip col-md-6" style="width:50%"  id="cost" required="required"') ?>
                        <?= form_input('rate', (isset($_POST['rate']) ? $_POST['rate'] : ($product ? $this->sma->formatDecimal($product->rate) : '')), 'class="form-control tip col-md-6"  style="width:50%" placeholder="Rate" id="prate" required="required"') ?>
                        <?= form_input('purchase_tax_type', $Settings->purchase_tax_type, 'class="form-control tip" id="purchase_tax_type" style="display:none;"') ?>
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group all">
                        ...
                        echo form_dropdown('per_type', $per, (isset($_POST['per_type']) ? $_POST['per_type'] : ($product ? $product->per_type : '')), 'class="form-control select" id="per_type" placeholder="' . lang("select") . " " . lang("per_type") . '" required="required" style="width:100%"')
                        ?>
                    </div>
                    ...
                    <!-- <div class="form-group all">
                        <?= lang("member_price", "member_price") ?>
                        <?= form_input('member_price', (isset($_POST['member_price']) ? $_POST['member_price'] : ($product ? $this->sma->formatDecimal($product->member_price) : '')), 'class="form-control tip" id="member_price" required="required"') ?>
                    </div> -->
...
<script type="text/javascript">
    $(document).ready(function(){
        $("#prate").keyup(function(){
            ...
            }else
            {
                ...
                $.ajax({
                        ...
                        url: "<?= site_url('products/tax_rate') ?>/"+t+"/"+r,
        ...
        //                 url: "<?= site_url('products/tax_cost') ?>/"+t+"/"+c,
