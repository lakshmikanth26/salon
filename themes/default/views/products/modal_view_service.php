                        ...
                        <table class="table table-borderless table-striped dfTable table-right-left">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td><?= lang("hsn_sac"); ?></td>
                                        <td><?php echo $product->hsn_sac; ?></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td><?= lang("per_types"); ?></td>
                                        <td><?php echo $per_types->name; ?></td>
                                    </tr>
                                    <?php if ($Owner || $Admin) {
...
<?php if (!$Supplier || !$Customer) { ?>
    <div class="buttons">
        <div class="btn-group btn-group-justified">
            <div class="btn-group">
                <a onclick="window.open('<?= site_url('services/single_barcode/' . $product->id) ?>', 'sma_popup', 'width=900,height=600,menubar=yes,scrollbars=yes,status=no,resizable=yes,screenx=0,screeny=0'); return false;"
            ...
            <div class="btn-group">
                <a onclick="window.open('<?= site_url('services/single_label/' . $product->id) ?>', 'sma_popup', 'width=900,height=600,menubar=yes,scrollbars=yes,status=no,resizable=yes,screenx=0,screeny=0'); return false;"
            ...
            <div class="btn-group">
                <a onclick="window.open('<?= site_url('services/single_label2/' . $product->id) ?>', 'sma_popup', 'width=900,height=600,menubar=yes,scrollbars=yes,status=no,resizable=yes,screenx=0,screeny=0'); return false;"
            ...
            <div class="btn-group">
                <a href="<?= site_url('services/pdf/' . $product->id) ?>" class="tip btn btn-primary" title="<?= lang('pdf') ?>">
            ...
            <?php if($product->type == 'standard') { ?>
                <div class="btn-group"><a data-target="#myModal2" data-toggle="modal"
                    href="<?= site_url('services/add_adjustment/' . $product->id) ?>"
            ...
            <?php } ?>
            <div class="btn-group">
                <a href="<?= site_url('services/edit/' . $product->id) ?>" class="tip btn btn-warning tip" title="<?= lang('edit_product') ?>">
            ...
            <div class="btn-group">
                <a href="#" class="tip btn btn-danger bpo" title="<b><?= $this->lang->line("delete_product") ?></b>"
                    data-content="<div style='width:150px;'><p><?= lang('r_u_sure') ?></p><a class='btn btn-danger' href='<?= site_url('services/delete/' . $product->id) ?>'><?= lang('i_m_sure') ?></a> <button class='btn bpo-close'><?= lang('no') ?></button></div>"
