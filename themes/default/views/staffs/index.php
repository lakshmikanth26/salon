<script>
    $(document).ready(function () {
        var oTable = $('#StaffData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('staffs/getStaffs') ?>',
...
<?php if ($Owner) {
    echo form_open('staffs/staff_actions', 'id="action-form"');
} ?>
<div class="box">
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?= site_url('staffs/add'); ?>" data-toggle="modal" data-target="#myModal"
                               id="add"><i class="fa fa-plus-circle"></i> <?= lang("add_staff"); ?></a></li>
                        <li><a href="<?= site_url('staffs/import_csv'); ?>" data-toggle="modal"
                        ...
                        <li class="divider"></li>
                        <li><a href="#" class="bpo" title="<b><?= $this->lang->line("delete_staffs") ?></b>"
                               data-content="<p><?= lang('r_u_sure') ?></p><button type='button' class='btn btn-danger' id='delete' data-action='delete'><?= lang('i_m_sure') ?></a> <button class='btn bpo-close'><?= lang('no') ?></button>"
                               data-html="true" data-placement="left"><i
                                    class="fa fa-trash-o"></i> <?= lang('delete_staffs') ?></a></li>
                    </ul>
                </li>
            </ul>
        </div>
