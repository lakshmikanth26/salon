<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo form_open_multipart("staffs/import_csv", $attrib); ?>
        <div class="modal-body">
            <p><?= lang('enter_info'); ?></p>

            <div class="well well-small">
                <a href="<?php echo base_url(); ?>assets/csv/sample_staff.csv" class="btn btn-primary pull-right"><i
                ...
                <span class="text-warning"><?= lang("csv1"); ?></span><br/><?= lang("csv2"); ?> <span class="text-info">(<?= lang("company") . ', ' . lang("name") . ', ' . lang("email") . ', ' . lang("phone") . ', ' . lang("address") . ', ' . lang("city"); ?>
                    ,  <?= lang("state") . ', ' . lang("postal_code") . ', ' . lang("country") . ', ' . lang("stcf1") . ', ' . lang("stcf2") . ', ' . lang("stcf3") . ', ' . lang("stcf4") . ', ' . lang("stcf5") . ', ' . lang("stcf6"); ?>
                    )</span> <?= lang("csv3"); ?><br>
